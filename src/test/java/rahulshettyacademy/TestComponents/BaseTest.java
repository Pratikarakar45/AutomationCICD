...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+ "\\src\\main\\java\\pratikaravkar\\resources\\Globledata.properties");
		prop.load(fis);
...
//		firefox
		System.setProperty("WebDriver.firefox.driver","gecko.exe");
